 ...
 */
Ext.define('Ck.testwindow.Controller', {
	extend: 'Ck.Controller',
	alias: 'controller.cktestwindow',
	...
	testwindow: function(config) {
		...
		this.getMap().testwindow(owsLayer, null, (this.getInsertFirst())? 0 : Infinity);
	}
});
